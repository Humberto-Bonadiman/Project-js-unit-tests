...
```javascript
  ...
  git clone git@github.com:Humberto-Bonadiman/Project-js-unit-tests.git
```
...
O requisito dez não foi realizado por dificuldade de compreensão do que era solicitado e o mesmo não será realizado em momento futuro, finalizando assim o projeto.
